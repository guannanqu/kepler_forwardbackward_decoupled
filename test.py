...
def main() -> None:
    ...
    parser.add_argument("experiment", choices=["mlp", "cnn", "online"], help="Which experiment to run.")
    ...
    if args.experiment == "online":
        online_test.run_experiment(online_test.build_parser().parse_args(remaining))
        return
